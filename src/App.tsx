  ...
  },
  {
    ...
    caseSections: [
      ...
      },
      {
        ...
        images: ["/projects/Checkout.png", "/projects/Checkout1.png", "/projects/Checkout2.png", "/projects/Checkout3.png"],
      },
      {
        title: "Процесс",
        text: "Вместе с исследователем проводил интервью с пользователями. Собирал результаты предыдущих исследований и экспериментов, фиксировал проблемы в CJM и переводил их в гипотезы. Вместе с продактом оценивал потенциальный вклад изменений и приоритизировал решения для чекаута.",
