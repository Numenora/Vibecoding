...
const projects = [
  ...
  },
  {
    ...
    legacySlugs: ["teams-in-motion"],
    number: "03",
    title: "Рост сквозной конверсии",
    discipline: "Product design · Growth",
    year: "2026",
    description: "Системная работа с главной, каталогом, лендингами и профилем через серию продуктовых экспериментов, которые помогли увеличить сквозную конверсию на 20,6%.",
    image: "",
    caseSections: [
      {
        title: "Контекст",
        text: "Путь пользователя к обучению проходил через несколько независимых точек входа: главную, каталог, продуктовые страницы и профиль. Локальные улучшения отдельных экранов не позволяли управлять всей воронкой, поэтому команде был нужен единый процесс поиска, проверки и масштабирования гипотез.",
      },
      {
        title: "Цель",
        text: "За первый квартал 2026 года увеличить сквозную конверсию на 5%: масштабировать успешные решения в каталоге, на главной и продуктовых страницах, улучшить участок воронки до оплаты и найти новые точки роста с потенциалом 5–10%.",
      },
      {
        title: "Моя роль",
        text: "Я отвечал за продуктовый дизайн в зоне главной, каталога и лендингов: переводил гипотезы в пользовательские сценарии, проектировал изменения интерфейса и вместе с продуктом, аналитикой, разработкой и контент-командой готовил решения к экспериментам.",
      },
      {
        title: "Подход",
        text: "Мы объединили две линии работы: быстро масштабировали уже подтверждённые решения и параллельно формировали следующий портфель гипотез. Проверяли прямой путь к подписке с главной, поиск по направлениям, новые сценарии каталога, квизы и шаблоны продуктовых страниц, а также дожимные механики в профиле.",
      },
      {
        title: "Результат",
        text: "Цель квартала была достигнута. Команда нашла два новых статистически значимых эксперимента: дожимной сценарий дал прирост 10,6%, а поиск на главной — 20,4%. С учётом масштабированных решений сквозная конверсия относительно органического сценария выросла примерно на 20,6%.",
      },
    ],
  },
