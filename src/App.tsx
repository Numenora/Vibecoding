...
const withMediaVersion = (src: string) => `${withBase(src)}?v=20260831-4`;
...
const projects = [
  {
    ...
    caseSections: [
      {
        title: "Контекст",
        text: "Авторы готовили курсы в Notion, Wiki и других редакторах, а контент-администраторы вручную переносили материалы в админку Практикума. Множество передач между людьми и системами заставляло команду повторно собирать уже созданный контент, растягивало согласования и усложняло контроль версий.",
        images: ["/projects/Editor_old0.png", "/projects/Editor_old1.png"],
      },
      {
        title: "Решение",
        text: "Мы спроектировали Notion-like редактор внутри админки и сделали его единой точкой входа для всей команды. Авторы собирают курс сразу в продуктовой среде, а методисты и дизайнеры обсуждают изменения в контексте. Ручной перенос исчез: контент-администраторы теперь занимаются только финальной настройкой уроков перед запуском.",
        images: ["/projects/Editor.png", "/projects/Editor1.png"],
      },
      {
        title: "Результат",
  ...
  },
  {
    ...
    caseSections: [
      ...
      },
      {
        ...
        images: ["/projects/Checkout.png", "/projects/Checkout1.png", "/projects/Checkout2.png"],
      },
      {
        title: "Процесс",
        text: "Я исследовал путь покупки, помогал составлять дизайн исследования и вместе с исследователем проводил интервью с пользователями. Собирал результаты предыдущих исследований и экспериментов, фиксировал проблемы в CJM и переводил их в гипотезы. Вместе с продактом оценивал потенциальный вклад изменений и приоритизировал решения для чекаута.",
        images: ["/projects/Process01.png", "/projects/Process02.png"],
      },
      {
        title: "Результат",
